(function (root, factory) {
  ...
  // validated here: `seasonInfo` (series/anime) and `platforms` (game, a
  // string[] of release platform names). Absent is fine; when present their
  // shape is not enforced — same treatment for both.
