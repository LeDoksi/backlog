...
(function (root, factory) {
  ...
  //
  // Ships its own repair: the next pull after this lands simply stops mentioning
  // those fields, so the corrupted local mirror clears itself on the next load
  // and the NULLs left in Postgres become permanently inert.
