...
const TITLES = [
  ...
  },
  {
    ...
    status: 'done',
    airingStatus: 'ongoing',
    seasonInfo: '4 сезона (2019–2024)\nСезон 5 — заключительный, уже отснят, премьера ожидается в 2026 году (точная дата не объявлена).',
    year: 2019,
  ...
  },
  {
    ...
    status: 'queue',
    airingStatus: 'ongoing',
    seasonInfo: '3 сезона (2018–2024) и фильм (2022)\nСезон 4 — выходит с апреля по сентябрь 2026 года; вышел также второй фильм (февраль 2026).',
    year: 2018,
