...
const TITLES = [
  ...
  },
  {
    ...
    status: 'done',
    airingStatus: 'completed',
    seasonInfo: 'Законченный минисериал (2022, 6 серий); второй сезон не анонсирован, история Камалы Хан продолжилась в фильме «Марвелы».',
    year: 2022,
  ...
  },
  {
    ...
    status: 'done',
    airingStatus: 'completed',
    seasonInfo: 'Законченный минисериал (2022, 9 серий); продолжение официально не анонсировано.',
    year: 2022,
  ...
  },
  {
    ...
    status: 'done',
    airingStatus: 'completed',
    seasonInfo: 'Вышло 2 сезона коротких серий (2022, 2023) по 5 эпизодов; третий сезон обсуждается создателями, но официально не подтверждён.',
    year: 2022,
  ...
  },
  {
    ...
    status: 'done',
    airingStatus: 'completed',
    seasonInfo: 'Законченный минисериал (2023, 6 серий); продолжение официально не анонсировано.',
    year: 2023,
  ...
  },
  {
    ...
    status: 'done',
    airingStatus: 'completed',
    seasonInfo: 'Законченный минисериал (2024, 5 серий), первый релиз под брендом Marvel Spotlight; продолжение не анонсировано.',
    year: 2024,
  ...
  },
  {
    ...
    status: 'done',
    airingStatus: 'completed',
    seasonInfo: 'Законченный минисериал (2024, 9 серий); по словам создателей и актёров, второй сезон не планируется — история Агаты задумывалась как разовая, как и «Ванда/Вижн».',
    year: 2024,
  ...
  },
  {
    ...
    status: 'done',
    airingStatus: 'ongoing',
    seasonInfo: 'Первый сезон вышел в январе 2025 года; шоу продлено минимум на три сезона, второй сезон перенесён на январь 2027 года.',
    year: 2025,
  ...
  },
  {
    ...
    status: 'done',
    airingStatus: 'ongoing',
    seasonInfo: 'Вышло 2 сезона (2025; 2026, финал в мае); сериал продлён на третий сезон с премьерой в марте 2027 года.',
    year: 2025,
  ...
  },
  {
    ...
    status: 'done',
    airingStatus: 'completed',
    seasonInfo: 'Законченный минисериал (2025, 6 серий); второй сезон официально не подтверждён и не отменён — будущее шоу остаётся неясным.',
    year: 2025,
  ...
  },
  {
    ...
    status: 'done',
    airingStatus: 'completed',
    seasonInfo: 'Законченная антология (2025, 4 серии); второй сезон официально не подтверждён, хотя создатели не исключают продолжения.',
    year: 2025,
    genres: ['приключения', 'боевик', 'фэнтези'],
    rating: null,
  ...
  },
  {
    ...
    status: 'done',
    airingStatus: 'ongoing',
    seasonInfo: 'Первый сезон вышел в октябре 2025 года (4 серии); сериал продлён на второй сезон, премьера которого ожидается не раньше 2027–2028 года.',
    year: 2025,
  ...
  },
  {
    ...
    status: 'done',
    airingStatus: 'completed',
    seasonInfo: 'Первый сезон вышел в январе 2026 года (8 серий) и получил хорошие отзывы критиков; несмотря на изначальное продление, в июле 2026 года Disney+ отменил сериал после одного сезона.',
    year: 2026,
  ...
  },
  {
    ...
    status: 'queue',
    airingStatus: 'completed',
    seasonInfo: 'Премьера восьмисерийного минисериала запланирована на 14 октября 2026 года как заключительная часть трилогии «Ванда/Вижн»; продолжение не анонсировано.',
    year: 2026,
