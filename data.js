...
const TITLES = [
  ...
  {
    id: 'jay-and-silent-bob-s-super-groovy-cartoon-movie-2013',
    title: 'Супер-пупер мультфильм от Джея и Молчаливого Боба',
    category: 'movie',
    status: 'queue',
    airingStatus: null,
    year: 2013,
    ...
    rating: null,
    synopsis: 'Сорвав куш в лотерею, Джей и Молчаливый Боб становятся супергероями Блантменом и Хроником, обзаводятся штабом под видеопрокатом и бросают вызов банде злодеев «Лига Засранцев», угрожающей их родному городку.',
    cover: 'images/covers/jay-and-silent-bob-s-super-groovy-cartoon-movie-2013.jpg'
  },
  {
