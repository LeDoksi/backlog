...
const TITLES = [
  ...
  },
  {
    ...
    status: 'queue',
    airingStatus: 'ongoing',
    seasonInfo: '4 сезона «Castlevania» (2017–2021, завершён) и 2 сезона «Nocturne» (2023, 2025)\nСудьба «Nocturne» неясна: с начала 2025 года Netflix не продлил и не закрыл сериал.',
    year: 2017,
  ...
  },
  {
    ...
    status: 'queue',
    airingStatus: 'completed',
    seasonInfo: '2 мини-сериала: «Revelation» (2021, 10 серий) и «Revolution» (2024, 5 серий); история рассказана полностью, продолжение не анонсировано.',
    year: 2021,
